...
This konnector retrieves your bills from the car sharing service Citiz.
...
```javascript
{
  ...
  "fields": {"login":"zuck.m@rk.fb", "password":"123456", "providerId":"1"}
}
```
Then :
...
The lead maintainers for this konnector is Erwan Guyader.
...
Cozy Citiz is developed by Erwan Guyader and distributed under the [AGPL v3 license][agpl-3.0].
